...
const CandidatoForm = ({ handlerPdfFileChange, cvFileError, deleteFile }) => {
        ...
        <div className="col-12 mb-4">
          ...
          <div>
            <div className="file-upload btn btn-secondary">
              ...
              <input type="file" id="cv-upload" onChange={handlerPdfFileChange} />
            </div>
            <button id="pdf-delete" type="button" className="btn btn-outline-secondary" onClick={deleteFile}>
              <i className="bi bi-trash" />
              Borrar
            </button>
            {cvFileError ? <div className="file-error">{cvFileError}</div> : null}
          </div>
        </div>
...
CandidatoForm.propTypes = {
  handlerPdfFileChange: PropTypes.func.isRequired,
  cvFileError: PropTypes.string.isRequired,
